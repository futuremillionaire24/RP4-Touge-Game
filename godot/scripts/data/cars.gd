...
const CARS := {
	"mame_k": {
		...
		"paint": Color(0.95, 0.72, 0.1), "finish": "gloss", "wheel_design": "sport5",
	...
	"hachi_gt": {
		...
		"paint": Color(0.93, 0.93, 0.92), "paint2": Color(0.08, 0.08, 0.09), "finish": "gloss", "two_tone": true, "wheel_design": "watanabe8",
	...
	"kyudo_type_s": {
		...
		"paint": Color(0.93, 0.93, 0.95), "finish": "gloss", "wheel_design": "spoke5",
		"model_path": "res://assets/models/cars/sports_hatch.glb",
	...
	"sylph_s2": {
		...
		"paint": Color(0.12, 0.2, 0.55), "finish": "metallic", "wheel_design": "forged6",
	...
	"rotora_fd": {
		...
		"paint": Color(0.75, 0.04, 0.06), "finish": "gloss", "wheel_design": "split5",
	...
	"tatsu_ix": {
		...
		"paint": Color(0.82, 0.83, 0.85), "finish": "metallic", "wheel_design": "rally8",
		"model_path": "res://assets/models/cars/sports_sedan.glb",
	...
	"senko": {
		...
		"paint": Color(0.08, 0.08, 0.09), "finish": "pearl", "pearl": Color(0.25, 0.2, 0.5), "wheel_design": "spoke5",
	...
	"titan_rz": {
		...
		"paint": Color(0.95, 0.42, 0.05), "finish": "gloss", "wheel_design": "split5",
	...
	"raijin_r": {
		...
		"paint": Color(0.18, 0.28, 0.62), "finish": "metallic", "wheel_design": "forged6",
	...
	"kaido_van": {
		...
		"paint": Color(0.9, 0.9, 0.88), "finish": "gloss", "wheel_design": "rally8",
	...
	"mugen_proto": {
		...
		"paint": Color(0.1, 0.85, 0.55), "finish": "satin", "wheel_design": "split5",
		"model_path": "res://assets/models/cars/race_future.glb",
