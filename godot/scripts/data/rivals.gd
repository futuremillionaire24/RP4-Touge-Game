...
const RIVALS := {
	"takumi": {"name": "Marc D.", "title": "Master of the Corniche", "car": "hachi_gt", "color": Color(0.95, 0.95, 0.93),
	...
	"keisuke": {"name": "Klaus W.", "title": "Alpine Apex", "car": "rotora_fd", "color": Color(0.8, 0.05, 0.05),
	...
	"blackbird": {"name": "Laurent M.", "title": "Autoroute Ghost", "car": "titan_rz", "color": Color(0.03, 0.03, 0.035),
	...
	"mika": {"name": "Camille R.", "title": "Monte-Carlo Queen", "car": "kyudo_type_s", "color": Color(1.0, 0.85, 0.1),
	...
	"goro": {"name": "Antoine V.", "title": "Port Hercule Boss", "car": "kaido_van", "color": Color(0.9, 0.9, 0.88),
	...
	"yuna": {"name": "Elena V.", "title": "Riviera Rally Specialist", "car": "tatsu_ix", "color": Color(0.1, 0.3, 0.7),
	...
	"champion": {"name": "Sebastien R.", "title": "Festival Champion", "car": "kurogane_hyper", "color": Color(0.92, 0.68, 0.12),
